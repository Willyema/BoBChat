...
public class quitOrLogDiag extends JDialog {
    ...
    private void onOK() {
        try {
            ...
            l.error("Error in quit or log Dialogue");
    ...
    public void createUI() {
        quitOrLogDiag dialog = new quitOrLogDiag();
        dialog.pack();
